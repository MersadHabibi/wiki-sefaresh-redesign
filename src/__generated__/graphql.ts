...
export type ExperienceByIdForMetaQueryVariables = Exact<{
  experienceId: Scalars['ID']['input'];
}>;


export type ExperienceByIdForMetaQuery = { __typename?: 'Query', experience: { __typename?: 'Experience', title: string, body: string } };

export type StoreByIdForMetaQueryVariables = Exact<{
  storeId: Scalars['ID']['input'];
}>;


export type StoreByIdForMetaQuery = { __typename?: 'Query', store: { __typename?: 'Store', name: string, activityField: string } };
...
export type LastStoresQueryVariables = Exact<{ [key: string]: never; }>;


export type LastStoresQuery = { __typename?: 'Query', lastStores: Array<{ __typename?: 'Store', id: string, name: string, activityField: string, website?: string | null, experiencesCount: number, score: number } | null> };
...
export const LastStoresDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LastStores"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lastStores"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"activityField"}},{"kind":"Field","name":{"kind":"Name","value":"website"}},{"kind":"Field","name":{"kind":"Name","value":"experiencesCount"}},{"kind":"Field","name":{"kind":"Name","value":"score"}}]}}]}}]} as unknown as DocumentNode<LastStoresQuery, LastStoresQueryVariables>;
